...
<p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;"><?= __('Su contraseña fue cambiada correctamente, ahora ya puede ingresar con su nueva contraseña.') ?></p>
...
<p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">¡Excelente día!</p>