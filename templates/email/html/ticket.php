...
?>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%; border-collapse:collapse; background:#f3f6fb; margin:0; padding:0;">
    <tr>
        <td align="center" style="padding:28px 14px;">
            <table role="presentation" width="640" cellpadding="0" cellspacing="0" style="width:100%; max-width:640px; border-collapse:collapse; background:#ffffff; border:1px solid #e5eaf2; border-radius:8px; overflow:hidden; font-family:Arial, Helvetica, sans-serif;">
                ...
                <?php endif; ?>
                <tr>
                    <td style="background:<?= $primary ?>; padding:28px 30px;">
                        <p style="margin:0 0 8px; color:rgba(255,255,255,0.78); font-size:12px; font-weight:700; letter-spacing:0; text-transform:uppercase;"><?= __('Pase digital confirmado') ?></p>
                        <h1 style="margin:0; color:#ffffff; font-size:30px; line-height:1.16; font-weight:800; letter-spacing:0;"><?= h($event->name) ?></h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding:30px;">
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%; border-collapse:collapse; background:#fff7ed; border:1px solid #fed7aa; border-radius:8px;">
                            <tr>
                                <td style="padding:16px; color:#9a3412; font-size:14px; line-height:1.5; font-weight:700;">
